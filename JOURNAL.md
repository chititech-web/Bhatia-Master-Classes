...
> **Maintained by:** Prabhakar (Tech Head — Chiti Technologies)
...
- Full marketing site with 10 sections, responsive, SEO-tagged (includes NEET 2026 Guess Paper lead generation)
...
### 👑 `[TECH HEAD]` — System Architect & Lead Developer

**Title:** Tech Head — Built by Chiti Technologies (https://www.chiti.tech/en)

**Role:** Entire digital presence — architecture, design, development, deployment. All frontend, all backend (Phase 1), all infrastructure.

**Attribution:** Footer of every page links to "Built with ♥ by Chiti Technologies"
...
| Guess Paper NEET 2026 section | `index.html` lines ~1974–2093 | Edit `#guess-paper` section, banner image path, PDF link |
...
│   ├── shyam-bhatia1.jpg      Mentor alternate photo (used in mentor section)
│   └── guess_paper_banner.jpeg  NEET 2026 guess paper promotional banner
│
├── assets/
│   ├── videos/
...
└── assets/pdfs/          DPP and PYQ downloadable files
    ...
    └── Guess_paper_NEET2026.pdf    NEET 2026 guess paper (added April 2026)
```
...
#### Phase 1.5 — Additions (April 2026)
- [x] **NEET 2026 Guess Paper Section** — New promotional section added to `index.html` between Admissions and Video Gallery with Bhatia Sir banner image, stats overlay (97 Chapters, 5000+ Downloads, 4.9/5 Rating), and lead capture form (Name, Phone, WhatsApp, State) with WhatsApp integration
- [x] **Guess Paper Banner Image** — Added `image/guess_paper_banner.jpeg` promotional image
- [x] **Guess Paper PDF** — Added `Guess_paper_NEET2026.pdf` to `assets/pdfs/` folder
- [x] **Live Classes Nav Link** — Added "Live Classes" link to navbar and footer quick links
- [x] **Lead Form Handler** — JavaScript handler for guess paper form with WhatsApp integration and auto-download

#### Phase 1.6 — June 2026
- [x] **JoSSA 2026 Counselling Section** — New promotional section added to `index.html` after Free Resources, before Admissions. Two product cards (600++ Choices at ₹599, 500 Top Choices at ₹499) with Instamojo buy links.
...
| Feature | Dept | Priority | Status | Notes |
|---|---|---|---|---|---|
| JoSSA 2026 Counselling section | `[FRONTEND]` `[CONTENT]` | 🟡 Medium | ✅ Done | Two product cards + Instamojo CTAs |
| Tech Head attribution in footer | `[FRONTEND]` | 🟡 Low | ✅ Done | "Built with ♥ by Chiti Technologies" |
| Replace Formspree placeholders with real form IDs | `[FRONTEND]` `[CONTENT]` | 🔴 Critical | Pending | Client action required |
| Upload video files + thumbnails | `[DEVOPS]` `[CONTENT]` | 🔴 Critical | Pending | Client to provide videos |
| Upload mentor photo | `[DEVOPS]` | 🟠 High | Pending | `image/shyam-bhatia.jpg` |
...
| Custom domain setup (bhatiamc.in) | `[DEVOPS]` | 🟡 Medium | Pending | GoDaddy DNS config |
...
*Last entry: April 16, 2026 — Prabhakar*
